...
export default function DashboardPage() {
  ...
  const headingColor = useColorModeValue('gray.700', 'white');
  const selectBg = useColorModeValue('white', 'black');
  const selectBorderColor = useColorModeValue('gray.200', 'gray.600');
  const tealColor = useChakraColor('teal.200');
    ...
    <Box maxW="1400px" mx="auto" py={5} px={{ base: 2, sm: 4, md: 6 }}>
      <Flex mb={6} justifyContent="space-between" alignItems="center">
        ...
        <FormControl id="domain-select-form" maxW="300px">
          ...
          <Select
            ...
            aria-labelledby="domain-select-form"
          >
            {domains.map((domain) => (
      ...
      {metrics.length > 0 && (
        <>
          ...
          <SectionHeading title="Keyword Positions" />
